...
- Split campaign work into two explicit submodules: preserve the existing three wide banners, then show all 40 supplied paid-ad assets for XRF, Cobra, Hydra Gen2, and VertiGo in a horizontally scrollable, click-to-enlarge library.
- Use imagery sourced from the real XRF Gen2 and Maker Business Lab websites for their live-project cards rather than generic editorial placeholders.
