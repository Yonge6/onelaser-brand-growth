...
- Present AI-generated machine application imagery in a dedicated real-world scenes module after the live-project archive: use a horizontally scrollable editorial rail with visible continuation, bilingual outcome-led captions, and click-to-enlarge previous/next navigation. The module should explain the machine, use context, and products or business opportunity at a glance, and remain extensible for future scenes.
