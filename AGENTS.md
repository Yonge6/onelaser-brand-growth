...
- Serve the three GitHub-origin projects from Alibaba-hosted static mirrors at `https://onelaser.wonderelian.com/home/`, `/collections/`, and `/xrf-gen2/?page=xrf`. Portfolio cards must use these same-origin URLs so domestic visitors do not depend on GitHub Pages at runtime; retain the GitHub sites as source and fallback only.
