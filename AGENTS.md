...
- Use the latest successful `Yonge6/xrf-gen2-listing` `main` commit as the cache version for the same-origin XRF Gen2 live project link; the current version is `a586abd`.
