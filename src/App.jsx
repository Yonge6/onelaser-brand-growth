...
const sceneImageSources = [
  ...
  { src: "assets/scenes/patriotic-custom-awards.webp", thumb: "assets/scenes/patriotic-custom-awards-thumb.jpg" },
  { src: "assets/scenes/sports-club-merchandise.webp", thumb: "assets/scenes/sports-club-merchandise-thumb.jpg" },
  { src: "assets/scenes/home-garage-production.webp", thumb: "assets/scenes/home-garage-production-thumb.jpg" },
  { src: "assets/scenes/after-hours-workshop.webp", thumb: "assets/scenes/after-hours-workshop-thumb.jpg" },
  { src: "assets/scenes/retail-personalization.webp", thumb: "assets/scenes/retail-personalization-thumb.jpg" },
  { src: "assets/scenes/family-heritage-art.webp", thumb: "assets/scenes/family-heritage-art-thumb.jpg" },
  { src: "assets/scenes/custom-drinkware-studio.webp", thumb: "assets/scenes/custom-drinkware-studio-thumb.jpg" },
  { src: "assets/scenes/full-machine-range.webp", thumb: "assets/scenes/full-machine-range-thumb.jpg" },
];
  ...
  en: {
    ...
    scenes: {
      ...
      items: [
        ...
        { title: "Patriotic custom awards", description: "High-value plaques and keepsakes for civic events, veteran groups and local commissions.", alt: "Maker holding an engraved eagle plaque beside a OneLaser Hydra Gen2 and patriotic keepsakes" },
        { title: "Sports club merchandise", description: "Team décor, trophies and supporter products built around match-day identity.", alt: "OneLaser product range staged in a sports-themed workshop with team merchandise" },
        { title: "Garage-based production", description: "A full-size workshop setup for signs, models, drinkware and repeatable local orders.", alt: "Couple working beside a OneLaser Hydra Gen2 in a bright residential garage workshop" },
        { title: "After-hours workshop", description: "A dedicated maker space that turns spare hours into focused production time.", alt: "OneLaser Hydra Gen2 in a dark industrial home garage with a tool bench" },
        { title: "Retail personalization", description: "On-demand engraving for gifts, drinkware and leather goods at the point of sale.", alt: "Customer and shop owner beside a OneLaser VertiGo and personalized retail products" },
        { title: "Family heritage art", description: "Large-format wood artwork and keepsakes designed around stories worth passing on.", alt: "Father and son holding a large engraved wood artwork beside a OneLaser Hydra Gen2" },
        { title: "Custom drinkware studio", description: "Colorful personalized tumblers produced for gifting, retail and recurring orders.", alt: "Two women in a drinkware studio beside a OneLaser VertiGo and custom tumblers" },
        { title: "A machine for every stage", description: "A clear product ladder from compact personalization to large-format production.", alt: "Four OneLaser machines arranged together on a red and black studio set" },
      ],
    },
    brochure: {
  ...
  zh: {
    ...
    scenes: {
      ...
      items: [
        ...
        { title: "爱国主题定制礼品", description: "面向节庆、退伍军人社群与本地定制订单的高价值牌匾与纪念品。", alt: "创客手持雕刻鹰徽牌匾，身旁是 OneLaser Hydra Gen2 与爱国主题纪念品" },
        { title: "球队周边与奖杯", description: "围绕赛事、球队身份与球迷需求制作装饰、奖杯和周边产品。", alt: "OneLaser 产品矩阵陈列在体育主题工作室与球队周边场景中" },
        { title: "家庭车库生产", description: "在家庭车库中承接标牌、模型、杯具与可重复的本地订单。", alt: "一对创客在明亮的家庭车库工作室中使用 OneLaser Hydra Gen2" },
        { title: "下班后的创作空间", description: "把独立车库变成专注生产空间，让业余时间转化为持续产出。", alt: "OneLaser Hydra Gen2 位于配有工具台的暗调工业风家庭车库中" },
        { title: "门店即时定制", description: "在销售现场为礼品、杯具与皮革制品提供即时雕刻服务。", alt: "顾客与店主在 OneLaser VertiGo 和个性化零售商品旁交流" },
        { title: "家庭传承艺术", description: "围绕值得传承的家庭故事，制作大幅木艺作品与纪念品。", alt: "父子手持大型雕刻木艺作品，身旁是 OneLaser Hydra Gen2" },
        { title: "定制杯具工作室", description: "为礼赠、零售与复购订单持续生产个性化彩色杯具。", alt: "两位女性在 OneLaser VertiGo 与彩色定制杯具旁交流" },
        { title: "覆盖不同阶段的设备矩阵", description: "从轻量个性化到大幅面生产，用完整设备矩阵覆盖不同业务阶段。", alt: "四台 OneLaser 设备陈列在红黑色影棚场景中" },
      ],
    },
    brochure: {
      label: "产品出版物",
